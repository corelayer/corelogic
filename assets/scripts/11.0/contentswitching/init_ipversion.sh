...
inputFilename_init_ipversion_trafficmanagement_contentswitching_policies="$inputFilename_init_basePath"'/init_ipversion_trafficmanagement_contentswitching_policies.yaml'
inputFilename_init_ipversion_trafficmanagement_contentswitching_policylabels="$inputFilename_init_basePath"'/init_ipversion_trafficmanagement_contentswitching_policylabels.yaml'
inputFilename_init_ipversion_trafficmanagement_contentswitching_policylabelbindings="$inputFilename_init_basePath"'/init_ipversion_trafficmanagement_contentswitching_policylabelbindings.yaml'

###

outputFilename_init_basePath='assets/framework/$version/packages/contentswitching/$protocol'
outputFilename_init="$outputFilename_init_basePath"'/init_$ipversion.yaml'
...
create_init() {
  ...
  create_object $version $protocol $ipversion "" $inputFilename_init_ipversion_trafficmanagement_contentswitching_policies $outputFilename

  add_section_header_trafficmanagement_contentswitching_policylabels $outputFilename
  create_object $version $protocol $ipversion "" $inputFilename_init_ipversion_trafficmanagement_contentswitching_policylabels $outputFilename

  add_section_header_trafficmanagement_contentswitching_policylabelbindings $outputFilename
  create_object $version $protocol $ipversion "" $inputFilename_init_ipversion_trafficmanagement_contentswitching_policylabelbindings $outputFilename
...
create_init $version $protocol ipv4 101
create_init $version $protocol ipv6 101
